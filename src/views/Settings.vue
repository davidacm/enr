<template>
  <div id="Settings" class="vh-100">
    <b-container fluid>
      ...
      <b-row class="row-spacing">
        <b-col>
            <b-form-checkbox v-model="useSlider" switch>
              Usar control deslizante para moverse por las notas
            </b-form-checkbox>
          </b-col>
      </b-row>
      <b-row class="row-spacing">
      ...
      <div v-show="isSynthAvailable && useTts">
        ...
        <b-row class="row-spacing">
          <b-col>
            <label for="voices">Seleccione la voz para leer notas</label>
          </b-col>
          <b-col>
...
export default {
  ...
  methods: {
    saveVoiceSettings() {
      local.vLang = this.vLang;
      local.vVoice = this.vVoice;
      local.rate = this.rate;
